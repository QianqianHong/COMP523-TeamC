...
test('add record', async () => {
  ...
  const closedtest = new Object({
    ...
    employment_status: 'EMPLOYMENT STRING',
...
test('add unformatted record', async () => {
  ...
  const closedtest = new Object({
    uid: 2,
    'bad field': 'bad data',
    closure_date: 'DATE STRING with no bad field behind it',
    employment_status: 'EMPLOYMENT STRING',
    engagement_activities: ['ENG 1', 'ENG 2'],
    closure_reason: ['REASON 1', 'REASON 2'],
  })
...
test('update record', async () => {
  ...
  const closedtest = new Object({
    uid: 2,
    ESP: 'ESP STRING',
    closure_date: 'DATE STRING with no bad date in ESP behind it',
    employment_status: 'EMPLOYMENT STRING',
    engagement_activities: ['ENG 1', 'ENG 2'],
    closure_reason: ['REASON 1', 'REASON 2'],
  })
